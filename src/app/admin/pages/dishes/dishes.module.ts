...
import { DishesOverviewComponent } from '@app/admin/pages/dishes/dishes-overview/dishes-overview.component';
...
import { translations } from '@app/admin/pages/dishes/translations';
import { CreatingEditingDishComponent } from '@app/admin/pages/dishes/creating-editing-dish/creating-editing-dish.component';
