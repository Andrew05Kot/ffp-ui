...
import { CompressCropImageService } from '@app/ffd-components/components/image-upload/service/compress-crop-image.service';
...
export class ImageUploadComponent implements OnInit {
  ...
  constructor(private imageCropAndCompressService: CompressCropImageService,
  ...
  private readeAndProcessImageOnLoad = (uploadedFile: ProgressEvent<FileReader>, fileType: string): void => {
    ...
    image.onload =
      () => this.resizeAndEmitPhoto(CompressCropImageService.crop(image, 1 / 1, fileType));
  }
