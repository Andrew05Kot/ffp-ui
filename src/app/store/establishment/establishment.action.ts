...
import { EstablishmentResponse, RequestParams } from '@app/models/backend';
...
declare global {
  interface Window {
    EstablishmentLoadAction: typeof EstablishmentLoadAction;
  }
}
window.EstablishmentLoadAction = EstablishmentLoadAction;
